...
LFp = @(x,myf) myf.a*(-myf.c2 + x)*(-myf.c5 + x)*(-1 + (-myf.c1 + x)*(-myf.c3 + x)*(-myf.c4 + x));

LF = @(x,myf) -myf.a*myf.c2*myf.c5*x - myf.a*myf.c1*myf.c2*myf.c3*myf.c4*myf.c5*x + 1/2*myf.a*myf.c2*x.^2 + ...
 1/2*myf.a*myf.c1*myf.c2*myf.c3*myf.c4*x.^2 + 1/2*myf.a*myf.c5*x.^2 + 1/2*myf.a*myf.c1*myf.c2*myf.c3*myf.c5*x.^2 + ...
 1/2*myf.a*myf.c1*myf.c2*myf.c4*myf.c5*x.^2 + 1/2*myf.a*myf.c1*myf.c3*myf.c4*myf.c5*x.^2 + ...
 1/2*myf.a*myf.c2*myf.c3*myf.c4*myf.c5*x.^2 - (myf.a*x.^3)/3 - 1/3*myf.a*myf.c1*myf.c2*myf.c3*x.^3 - ...
 1/3*myf.a*myf.c1*myf.c2*myf.c4*x.^3 - 1/3*myf.a*myf.c1*myf.c3*myf.c4*x.^3 - 1/3*myf.a*myf.c2*myf.c3*myf.c4*x.^3 - ...
 1/3*myf.a*myf.c1*myf.c2*myf.c5*x.^3 - 1/3*myf.a*myf.c1*myf.c3*myf.c5*x.^3 - 1/3*myf.a*myf.c2*myf.c3*myf.c5*x.^3 - ...
 1/3*myf.a*myf.c1*myf.c4*myf.c5*x.^3 - 1/3*myf.a*myf.c2*myf.c4*myf.c5*x.^3 - 1/3*myf.a*myf.c3*myf.c4*myf.c5*x.^3 + ...
 ...
 1/4*myf.a*myf.c1*myf.c5*x.^4 + 1/4*myf.a*myf.c2*myf.c5*x.^4 + 1/4*myf.a*myf.c3*myf.c5*x.^4 + ...
 1/4*myf.a*myf.c4*myf.c5*x.^4 - 1/5*myf.a*myf.c1*x.^5 - 1/5*myf.a*myf.c2*x.^5 - 1/5*myf.a*myf.c3*x.^5 - ...
 1/5*myf.a*myf.c4*x.^5 - 1/5*myf.a*myf.c5*x.^5 + (myf.a*x.^6)/6;
...
ylabel('CML state')
xlabel('Time (Weeks)')
%saveas(gcf,strcat('CML_TOTO_FP_trajectories_',num2str(gamma),'data2.png'))
...
ylabel('CML state')
xlabel('Time (Weeks)')
%saveas(gcf,strcat('CML_TOTO_FP_trajectories_',num2str(gamma),'data3.png'))
%}

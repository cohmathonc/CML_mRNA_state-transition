...
outlierfactor = 0.65; 
%f = [0.00315, 0.00225, 0.00815,  0.00485]'; %remove unstable point c2
%f = [0.006, 0.005, 0.01125, 0.001]'; %TKI distribution
f = [.8*0.002204351, outlierfactor*0.002422282, 0.001310297, 0.001322798]'; %rotated space only nonzero genes

% tetfactor = 2.5;
% %tet off / on 
% f = [(1/tetfactor)*0.00315, 0.00225, 0.00815,  tetfactor*0.00485]'; %remove unstable point c2
...
xlabel('time (weeks)')
set(gca,'ylim',[-.25 1.25],'ydir','reverse','xlim',[t0 tfpost],'ytick',sort(x),'yticklabel',{'healthy c_1','c_2','c_3','CML c_5'})
ax = gca; 

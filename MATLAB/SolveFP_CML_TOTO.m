...
LF = @(x,myf)1/4*(myf.c2*myf.c3*myf.c4*(4 + myf.c1.^2 - 6*myf.c1*myf.c5 + myf.c5.^2)*x - ...
   1/2*(myf.c2*myf.c4*(4 + myf.c1.^2 - 6*myf.c1*myf.c5 + myf.c5.^2) + ...
      myf.c3*myf.c4*(4 + myf.c1.^2 - 6*myf.c1*myf.c5 + myf.c5.^2) + ...
      myf.c2*myf.c3*(4 + myf.c1.^2 - 8*myf.c1*myf.c4 - 6*myf.c1*myf.c5 + myf.c5.^2))*x.^2 + ...
   1/3*(myf.c4*(4 + myf.c1.^2 - 6*myf.c1*myf.c5 + myf.c5.^2) + ...
      myf.c3*(4 + myf.c1.^2 - 8*myf.c1*myf.c4 - 6*myf.c1*myf.c5 + myf.c5.^2) + ...
      myf.c2*(4 + myf.c1.^2 + myf.c5.^2 - 2*myf.c1*(4*myf.c3 + 4*myf.c4 + 3*myf.c5)))*x.^3 - ...
   1/4*(4 + myf.c1.^2 + myf.c5.^2 - 2*myf.c1*(4*myf.c2 + 4*myf.c3 + 4*myf.c4 + 3*myf.c5))*x.^4 - ( 8*myf.c1*x.^5)/5);

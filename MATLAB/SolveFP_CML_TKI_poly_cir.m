...
LU = @(x,myf) -myf.a*myf.c1*myf.c2*myf.c5*x + 1/2*myf.a*(myf.c2*myf.c5 + myf.c1*(myf.c2 + myf.c5))*x.^2 - 1/3*myf.a*(myf.c1 + myf.c2 + myf.c5)*x.^3 + (myf.a*x.^4)/4;

LFp = @(x,myf) myf.a*myf.c1*myf.c2*myf.c3 - myf.a*myf.c1*myf.c2*myf.c5 + (-myf.a*myf.c1*myf.c3 - myf.a*myf.c2*myf.c3 + myf.a*myf.c1*myf.c5 + myf.a*myf.c2*myf.c5)*x...
    + (myf.a*myf.c3 - myf.a*myf.c5)*x.^2;

LF = @(x,myf) myf.a*myf.c1*myf.c2*(myf.c3 - myf.c5)*x + 1/6*myf.a*(-3*myf.c1 - 3*myf.c2)*(myf.c3 - myf.c5)*x.^2 + 1/3*myf.a*(myf.c3 - myf.c5)*x.^3;
...
LU = @(x,myf) -myf.a*myf.c1*myf.c2*myf.c5*x + 1/2*myf.a*myf.c1*myf.c2*x.^2 + 1/2*myf.a*myf.c1*myf.c5*x.^2 + 1/2*myf.a*myf.c2*myf.c5*x.^2 - ...
 1/3*myf.a*myf.c1*x.^3 - 1/3*myf.a*myf.c2*x.^3 - 1/3*myf.a*myf.c5*x.^3 + (myf.a*x.^4)/4;

LFp = @(x,myf) myf.a*(-myf.c1 + x)*(-myf.c2 + x)*(-myf.c5 + x) - myf.a*(-myf.c2 + x)*(-myf.c3 + x)*(-myf.c4 + x)*(1 + ((myf.c1 - myf.c5)/2 + x).^2);

LF = @(x,myf)myf.a*myf.c2*myf.c3*myf.c4*x + 1/4*myf.a*myf.c1^2*myf.c2*myf.c3*myf.c4*x - myf.a*myf.c1*myf.c2*myf.c5*x - ...
 1/2*myf.a*myf.c1*myf.c2*myf.c3*myf.c4*myf.c5*x + 1/4*myf.a*myf.c2*myf.c3*myf.c4*myf.c5^2*x + 1/2*myf.a*myf.c1*myf.c2*x.^2 - ...
 1/2*myf.a*myf.c2*myf.c3*x.^2 - 1/8*myf.a*myf.c1^2*myf.c2*myf.c3*x.^2 - 1/2*myf.a*myf.c2*myf.c4*x.^2 - ...
 1/8*myf.a*myf.c1^2*myf.c2*myf.c4*x.^2 - 1/2*myf.a*myf.c3*myf.c4*x.^2 - 1/8*myf.a*myf.c1^2*myf.c3*myf.c4*x.^2 + ...
 1/2*myf.a*myf.c1*myf.c2*myf.c3*myf.c4*x.^2 + 1/2*myf.a*myf.c1*myf.c5*x.^2 + 1/2*myf.a*myf.c2*myf.c5*x.^2 + ...
 1/4*myf.a*myf.c1*myf.c2*myf.c3*myf.c5*x.^2 + 1/4*myf.a*myf.c1*myf.c2*myf.c4*myf.c5*x.^2 + ...
 1/4*myf.a*myf.c1*myf.c3*myf.c4*myf.c5*x.^2 - 1/2*myf.a*myf.c2*myf.c3*myf.c4*myf.c5*x.^2 - ...
 1/8*myf.a*myf.c2*myf.c3*myf.c5^2*x.^2 - 1/8*myf.a*myf.c2*myf.c4*myf.c5^2*x.^2 - 1/8*myf.a*myf.c3*myf.c4*myf.c5^2*x.^2 - ...
 1/3*myf.a*myf.c1*x.^3 + 1/12*myf.a*myf.c1^2*myf.c2*x.^3 + 1/3*myf.a*myf.c3*x.^3 + ...
 1/12*myf.a*myf.c1^2*myf.c3*x.^3 - 1/3*myf.a*myf.c1*myf.c2*myf.c3*x.^3 + 1/3*myf.a*myf.c4*x.^3 + ...
 1/12*myf.a*myf.c1^2*myf.c4*x.^3 - 1/3*myf.a*myf.c1*myf.c2*myf.c4*x.^3 - 1/3*myf.a*myf.c1*myf.c3*myf.c4*x.^3 + ...
 1/3*myf.a*myf.c2*myf.c3*myf.c4*x.^3 - 1/3*myf.a*myf.c5*x.^3 - 1/6*myf.a*myf.c1*myf.c2*myf.c5*x.^3 - ...
 1/6*myf.a*myf.c1*myf.c3*myf.c5*x.^3 + 1/3*myf.a*myf.c2*myf.c3*myf.c5*x.^3 - 1/6*myf.a*myf.c1*myf.c4*myf.c5*x.^3 + ...
 1/3*myf.a*myf.c2*myf.c4*myf.c5*x.^3 + 1/3*myf.a*myf.c3*myf.c4*myf.c5*x.^3 + 1/12*myf.a*myf.c2*myf.c5^2*x.^3 + ...
 1/12*myf.a*myf.c3*myf.c5^2*x.^3 + 1/12*myf.a*myf.c4*myf.c5^2*x.^3 - 1/16*myf.a*myf.c1^2*x.^4 + ...
 1/4*myf.a*myf.c1*myf.c2*x.^4 + 1/4*myf.a*myf.c1*myf.c3*x.^4 - 1/4*myf.a*myf.c2*myf.c3*x.^4 + ...
 1/4*myf.a*myf.c1*myf.c4*x.^4 - 1/4*myf.a*myf.c2*myf.c4*x.^4 - 1/4*myf.a*myf.c3*myf.c4*x.^4 + ...
 1/8*myf.a*myf.c1*myf.c5*x.^4 - 1/4*myf.a*myf.c2*myf.c5*x.^4 - 1/4*myf.a*myf.c3*myf.c5*x.^4 - ...
 1/4*myf.a*myf.c4*myf.c5*x.^4 - 1/16*myf.a*myf.c5.^2*x.^4 - 1/5*myf.a*myf.c1*x.^5 + 1/5*myf.a*myf.c2*x.^5 + ...
 1/5*myf.a*myf.c3*x.^5 + 1/5*myf.a*myf.c4*x.^5 + 1/5*myf.a*myf.c5*x.^5 - (myf.a*x.^6)/6;
%}
...
savefig(gcf,strcat('CML_TKI_FPSurface',num2str(gamma),'.fig'))
%}
%% check trajectories
% adjust beta value
% TKI ON-OFF
...
%plot(T,Si(:,Si(ixe,:) < c5),'Color',[.6 .6 .6]); hold on;

for i =1:size(tet_off_nil_on_d_mid,1)
    ind = find(cmldata.mouse_id==tet_off_nil_on_d_mid(i));
    plot(cmldata.timepoint(ind),cmldata_cml_space(ind),'Color',[101 7 179]/255,'LineWidth',2); hold on;
...
xline(ti(2),'k','fontweight','bold','fontsize',16,'LineWidth',1.0); hold on;
xlim([0 18])
title('TKI','fontsize',14)
%ylabel('CML state')
...
set(gca,'YTick',[]);
%annotation('textbox',[.1 .5 .1 .2],'interpreter','latex','String','$c_1$','FitBoxToText','off');
saveas(gcf,strcat('CML_TKI_FP_trajectories_',num2str(gamma),'data.png'))
savefig(gcf,strcat('CML_TKI_FP_trajectories_',num2str(gamma),'data.fig'))
save(strcat('CML_TKI_FP_trajectories_',num2str(gamma),'data.mat'),"T","Si")
